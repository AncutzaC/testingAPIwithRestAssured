...
public class WorkingWithXML {
    ...
    // Convert the json response body  of the API that we use in our tests to an XML representation of that
    ...
    // XML path expression: root element, place of element, attribute with @
    @Test
